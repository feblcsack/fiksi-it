...
export default function HeroContent() {
  return (
    <div className="text-center my-0 p-0 px-0 py-16 rounded-4xl shadow-none bg-background/85 backdrop-blur-sm border-border border-none border-0">
      ...
      >
        <span className="instrument text-foreground mx-0 text-center font-normal font-mono font-lora">Musionic</span>
        <br />
        <span className="font-light text-md text-foreground tracking-tight">Music Studio</span>
      </h1>
