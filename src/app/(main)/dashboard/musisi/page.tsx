      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div>
          <div className="flex items-baseline justify-between mb-8">
            ...
            <span className="text-white/40 text-sm font-mono">{gigs.length}</span>
          </div>
              ...
              {gigs.map((gig) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 text-xs font-mono text-white/30">
                    <span>
                      {new Date(gig.datetime.toDate()).toLocaleDateString("en-US", {
                        month: "short",
                        day: "numeric",
                        year: "numeric"
                      })}
                    ...
                    <span>•</span>
                    <span>
                      {new Date(gig.datetime.toDate()).toLocaleTimeString("en-US", {
                        hour: "2-digit",
                        minute: "2-digit"
                      })}
                    </span>
